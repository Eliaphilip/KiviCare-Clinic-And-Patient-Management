...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (strlen($new_password) < 8) {
        ...
        $pdo->prepare("UPDATE users SET password = ? WHERE id = ?")
            ->execute([$hashed_password, $reset_request['user_id']]);
...
<head>
    ...
    <title>Set New Password | Kivicare - Medical Clinic & Patient Management</title>
    <!-- Config Options -->
                        ...
                        <div class="sign-user_card position-relative bg-white mx-auto">
                            ...
                            <form method="post">
                                ...
                                <div class="custom-form-field">
                                    ...
                                    <input type="password" name="confirm_password" id="confirm_password" class="form-control mb-4" 
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="show-password">Show passwords</label>
                                    </div>
                                </div>
                                
                                <button type="submit" class="iq-button text-capitalize border-0 w-100">
                                    <span class="iq-btn-text-holder position-relative">Update Password</span>
